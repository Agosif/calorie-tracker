...
const patchSchema = z.object({
  ...
  fiberG: z.number().int().nonnegative().optional(),
  sugarG: z.number().int().nonnegative().optional(),
  sodiumMg: z.number().int().nonnegative().optional(),
  satFatG: z.number().int().nonnegative().optional(),
